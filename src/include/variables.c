...
u16 G_ADR_VRAM_THUMB;

u16 G_ADR_VRAM_GONG;

u16 G_ADR_VRAM_DESK;

u16 G_ADR_VRAM_BG_A2;

struct_LARRY_BOXING_ larry_BOXING;
...
Sprite *sprite_CHRONO;

Sprite *sprite_HAMMER;

Sprite *sprite_WATCH_HAND;

Sprite *sprite_BOXERS;
